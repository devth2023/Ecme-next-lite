...
import OauthSignIn from "@/components/auth/SignIn/OauthSignIn"
import ActionLink from "@/components/shared/ActionLink"
import useTimeOutMessage from "@/utils/hooks/useTimeOutMessage"
import useTheme from "@/utils/hooks/useTheme"
import type { OnSignIn } from "@/components/auth/SignIn/SignInForm"
import type { OnOauthSignIn } from "@/components/auth/SignIn/OauthSignIn"
    ...
    <>
      ...
      <div>
        <div className="mt-6 text-center">
          ...
          <ActionLink href={signUpUrl} className="heading-text font-bold" themeColor={false}>
            Sign up
          </ActionLink>
        </div>
      </div>
